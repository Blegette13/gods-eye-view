...
export async function fetchBdpParcelTransportation(
  parcel,
  { fetchImpl = globalThis.fetch, signal } = {},
) {
  if (typeof fetchImpl !== 'function') throw new Error('A fetch implementation is required');
  if (!parcel?.property?.geometry) throw new Error('Parcel geometry is required for TxDOT screening');
...
export default fetchBdpParcelTransportation;
